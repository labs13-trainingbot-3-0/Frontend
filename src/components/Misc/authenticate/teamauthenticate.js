...
import Sadlogo from "img/sad-training-bot.png";
    ...
    render() {
      ...
      const notLoggedIn = (
        <>
          ...
          <LoginContainer>
            <LoginContent>
              <LogoImage src={Sadlogo} alt="loading" className="ld ld-bounce" />
              <h2>No User Found</h2>
              <p>Sorry, Please check the email you've used to sign and contact your your training bot admin.</p>
              <ButtonContainer>
